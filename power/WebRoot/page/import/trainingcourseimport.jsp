...
<html:html>
  ...
  <html:form action="searchPower" method="post" enctype="multipart/form-data">
	<html:hidden property="action" value="trainingcourseimportOperate"/>
  ...
  <div id="basic_info">
    <div class="infoTitle">
      <div class="left"><img src="<%=path%>/images/basic_info.gif" width="26" height="20" /> 培训课程表导入：</div> 
      <div class="right"></div>
    </div>
	  <div id="basic_infoMain">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
				    	...
				    	培训运行表：<html:file property="uploadFile" />
					</tr>
					<tr>
					<td></td>
					</tr>
