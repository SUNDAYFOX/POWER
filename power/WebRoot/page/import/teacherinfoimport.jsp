...
<html:html>
  ...
  <html:form action="searchPower" method="post" enctype="multipart/form-data">
	<html:hidden property="action" value="teacherinfoimportOperate"/>
  ...
  <div id="basic_info">
    <div class="infoTitle">
      <div class="left"><img src="<%=path%>/images/basic_info.gif" width="26" height="20" /> 教师信息表导入：</div> 
      <div class="right"></div>
    </div>
	  <div id="basic_infoMain">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
				    	...
				    	教师信息表：<html:file property="uploadFile" />
					</tr>
					<tr>
					<td></td>
					</tr>
